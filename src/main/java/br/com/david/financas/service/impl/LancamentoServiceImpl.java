...
import br.com.david.financas.models.repository.LancamentoRepository;
...
public class LancamentoServiceImpl implements LancamentoService {
	...
	public BigDecimal obterSaldoPorUsuario(Long id) {
		BigDecimal receitas = repository.obterSaldoPorTipoDeLancamento(id, TipoLancamento.RECEITA);
		BigDecimal despesas = repository.obterSaldoPorTipoDeLancamento(id, TipoLancamento.DESPESA);
